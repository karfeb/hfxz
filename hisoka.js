...
⭔ Detail: ${detail}`
            ...
            case 'list': case 'menu': case 'help': case '?': {
                anu = `Selamat ${salam} kak ${pushname}, 👋
Saya Hfxz, Bot Ini Adalah Beta Multi-Device WhatsApp.
